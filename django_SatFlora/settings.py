"""
Django settings for django_SatFlora project.
...
SECRET_KEY = 'django-insecure-6fs9&67cumqi$(oa1b50ij%1bl+l7tqfh-1(azahb#7cgny9y-'
...
WSGI_APPLICATION = 'django_SatFlora.wsgi.application'
